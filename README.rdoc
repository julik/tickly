...
is a literal expression in curly braces. An array with the +:b+ symbol at the beginning is an expression with
string interpolations (square brackets). If you are curious, +:c+ stands for "curlies" and +:b+ for "brackets". All the other array
